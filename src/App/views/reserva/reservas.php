    ...
    <main>
        ...
        <section>
            <article class="overflow_hidden informacion">
                ...
                <a href="local.html?local=moreno" class="link">Hacer Reserva</a>
            ...
            <article class="overflow_hidden informacion">
                ...
                <a href="local.html?local=rodriguez" class="link">Hacer Reserva</a>
                <a href="#" rel="external" target="_blank" class="link">Direcciones</a>  
            </article>
            <article class="overflow_hidden informacion">
                <h3>Luján</h3>
                <picture>
                    ...
                    <a href="local.html?local=lujan" class="link">Hacer Reserva</a>
                    <a href="#" rel="external" target="_blank" class="link">Direcciones</a>  
            </article>
            <article class="overflow_hidden informacion">
                <h3>Otro</h3>
                ...
                <a href="local.html?local=otro" class="link">Hacer Reserva</a>
                <a href="#" rel="external" target="_blank" class="link">Direcciones</a>  
            </article>
